<template>
  <div>
    <!-- <link rel="stylesheet" href="/node_modules/element-theme-chalk/lib/index.css"> -->
    <b-modal 
    ref="myModalRef" 
    title="Settings"
    v-model="show" 
    ...
    <b-card title="User interface Settings">
        ...
        <option v-for="item in this.$store.getters.getThemes">
        {{item}}
        </option>
        </b-form-select>
        ...
        <option v-for="item in this.$store.getters.getFonts">
        {{item}}
        </option>
        </b-form-select>
        ...
        <option v-for="item in this.$store.getters.getLanguages">
        {{item}}
        </option>
        </b-form-select>
  </b-card>
...
<b-card title="Download/Upload Limit">
    ...
    <b-row>
        <b-col>
           <b-input-group  prepend="Max Speed Download Limit" append="MBp/s">
    <b-form-input min="0" type="number"></b-form-input>
  </b-input-group>
        </b-col>
        <b-col>
           <b-input-group  prepend="Max Speed Upload Limit" append="MBp/s">
    <b-form-input min="0" type="number"></b-form-input>
  </b-input-group>
        </b-col>
    </b-row>
